...
\title{ICT Computer Architectures}	% Kurztitel in []
\author{DI Dr. Markus Quaritsch}
\date{WS 2015/16}		% \today für heutiges Datum verwenden
...
\graphicspath{ %
	{../beamer_theme/} %
	 {../Everything/img/} %
	 {../0_Preparatory/img/} %
	 {../1_Microprocessor_Fundamentals/img/} %
	 {../2_Processor_Examples/img/} %
	 {../3_System_Peripheral_Connect/img/} %
	 {../4_Networking/img/} %
}
